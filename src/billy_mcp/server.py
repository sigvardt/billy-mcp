...
from billy_mcp.api.balance_modifier_writes import register_balance_modifier_write_tools
...
from billy_mcp.api.currency_writes import register_currency_write_tools
...
from billy_mcp.api.locale_writes import register_locale_write_tools
...
def create_server(
    ...
    *,
    ...
    async def ui_invoices_update_open() -> UiInvoicesUpdateOpenSuccess | ToolError:
        """Observe an authenticated Billy invoice edit form without submitting."""
    ...
    async def ui_clients_update_open() -> UiClientsUpdateOpenSuccess | ToolError:
        """Observe an authenticated Billy client edit form (Ret) without submitting."""
    ...
    async def ui_bills_update_open() -> UiBillsUpdateOpenSuccess | ToolError:
        """Observe an authenticated Billy bill edit form without submitting."""
    ...
    server.tool(
        ...
        description=(
            "Open a Billy invoice draft edit form for the authenticated session "
    ...
    server.tool(
        name="ui_clients_update_open",
        description=(
            "Open a Billy client (contact) edit form for the authenticated session "
    ...
    server.tool(
        ...
        description=(
            "Open a Billy bill edit form for the authenticated session "
    ...
    register_locale_write_tools(server, client, write_protocol)
