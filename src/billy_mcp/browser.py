...
class LoginControl(Protocol):
    ...
    def filter(self, *, has: LoginControl) -> LoginControl: ...
...
class LoginPage(Protocol):
    ...
    def get_by_text(self, text: str, *, exact: bool = False) -> LoginControl: ...

    def get_by_label(self, text: str, *, exact: bool = False) -> LoginControl: ...
