...
Implement only contract claims supported by the approved design, cited official
Billy documentation, or reproducible non-production observations. Keep
unresolved inventory rows red.
