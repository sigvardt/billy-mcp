---
name: state
desc: Current Wave-5j bank-line offline product authority, scope, and delivery gates.
tags: [wave_fivej, bank_lines, writes]
sources:
...
The product must clone the Wave-5i sales-tax account/meta write pattern, use the
root shared confirmation service, preserve opaque inner resource maps, and
leave bulk, live, UI, vision, `bankPayments`, `balanceModifiers`, and overall
completion untouched. The delivery targets are 238 registered `api_*` tools,
