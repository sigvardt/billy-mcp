...
route/root map, and leaves all coverage rows red. Do not browse, use a browser,
create test data, or claim a fresh Grok verdict. If the freeze is internally
inconsistent, report the blocker to the parent rather than broadening scope.
