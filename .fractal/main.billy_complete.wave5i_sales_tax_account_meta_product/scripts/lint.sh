...
# The product leaf must satisfy the same repository checks as its parent before
# each commit; the stock seed validates only node metadata.
exec bash "$WORKTREE_DIR/.fractal/main.billy_complete/scripts/lint.sh"
