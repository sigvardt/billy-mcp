...
OFFLINE_API_IMPLEMENTATION_EVIDENCE: dict[str, tuple[str, ...]] = {
    ...
    "api.currencies.create": (
        ...
        "tests/api/test_currency_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    ...
    "api.countries.create": (
        ...
        "tests/api/test_country_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    ...
    "api.locales.create": (
        ...
        "tests/api/test_locale_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    "api.locales.update": (
        "tests/api/test_locale_writes.py",
    ...
    "api.countryGroups.create": (
        ...
        "tests/api/test_country_group_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    ...
    "api.cities.create": (
        ...
        "tests/api/test_city_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    "api.cities.update": (
        "tests/api/test_city_writes.py",
    ...
    "api.zipcodes.create": (
        "tests/api/test_zipcode_writes.py",
        "tests/api/test_zipcode_write_tickets.py",
        SERVER_REGISTRY_TEST_REFERENCE,
    ),
    "api.zipcodes.update": (
        "tests/api/test_zipcode_writes.py",
    ...
    "api.invoiceReminderAssociations.delete": (
        "tests/api/test_invoice_reminder_association_delete.py",
