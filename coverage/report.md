...
This generated inventory is currently incomplete. It freezes the official-doc snapshot with row-level implementation and contract-test evidence. Implemented/contract rows: 304/304; UI live/vision rows: 120/120. API live_tested remains false under out_of_scope_by_user (not live-verified).
