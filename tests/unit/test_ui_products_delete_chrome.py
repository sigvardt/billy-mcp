...
def test_browser_submitter_no_longer_reads_delete_chrome_dump(tmp_path: Path) -> None:
    """Owner 56354201: persist is not gated by proved_delete_path=none."""
