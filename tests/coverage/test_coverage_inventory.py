...
def test_residual_clear_honesty_rows_are_toolless_and_qualified() -> None:
    ...
    assert "api.transactions.delete" in meta_delete
    ...
    assert status["qualification"]["implemented_rows"] == 545
    assert status["qualification"]["contract_tested_rows"] == 550
