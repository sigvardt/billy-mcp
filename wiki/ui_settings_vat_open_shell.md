...
desc: Read-only Billy Indstillinger Momssatser (VAT) settings panel; dual-counts api.taxRates.list (research158).
tags: [billy, ui, settings, vat, momssatser, indstillinger, discovery, taxRates]
sources:
  - docs/superpowers/specs/2026-07-28-billy-mcp-complete-design.md
  - https://www.billy.dk/api/
created: 2026-07-31T22:10:00Z
updated: 2026-08-01T13:45:00Z
---
...
| Coverage rows | `ui.discovery.settings_vat`, `ui.parity.taxRates.list` (maps `api.taxRates.list`) |
...
- Soft seeds (`settings/vat`, `settings/moms`, `settings/tax`, `taxRates`, …) are **not** success.
...
- Does **not** green salesTax* / taxRateDeductionComponents UI parity (adjacent multi-resource panel content stays deferred).
- Offline salesTax API tools are a separate lane and are not greened by this open shell beyond taxRates.list dual-count.
