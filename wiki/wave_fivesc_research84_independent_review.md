---
name: wave_fivesc_research84_independent_review
title: Wave-5s-C research84 reconfirm independent review ACCEPT
desc: Authoritative root Grok acceptance of the research84 handoff reconfirm for ticketed invoice email and invoiceDeliveries; product and completeness remain open.
...
created: 2026-07-30T19:08:00Z
updated: 2026-07-30T19:08:00Z
---

# Wave-5s-C research84 reconfirm independent review ACCEPT

## Verdict

| Claim | Result |
| --- | --- |
| Wave-5s-C research84 handoff reconfirm | **ACCEPT** as research handoff only |
...
| Wave-5s-B product ACCEPT | **not accepted** — containment TOCTOU open; mandatory Grok product IR missing |
| Live, UI, vision, bulk, completeness | **not claimed / fail-closed** |

Full cited findings: `.fractal/main.billy_complete/tmp/grok-review.md` (review84).

## Independent verification summary

- Official docs re-fetch: ETag `"wcw4x9hqvu3603"`, 147934 bytes, MD5
  `8b94b0135c91fd15fe54ea33e088a4be` (byte-identical to research84 HTML).
- Unauth probes reconfirm email POST open at 401, non-POST 405; delivery POST
  ...
  POST 401 still offline-blocked (property table readonly except immutable
  organization).
...
- Upload execute has buffer SHA-256 before `post_file` but still path-based
  `read_bytes()` after resolve-based identity recheck; same-digest outside-root
  symlink containment remains open.
...
1. Containment repair for Wave-5s-B upload + **Grok** product IR of repaired
   Wave-5s-B.
2. Codex Power Wave-5s-C product leaf per freeze + product-ready +
   research83/84.
