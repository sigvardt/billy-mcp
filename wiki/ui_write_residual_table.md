...
| `ui.parity.invoices.delete` | `ui_invoices_delete_open` | `ui_invoices_delete_{preview,execute}` | Unique **Mere**, `A` **Slet**, then candidate dump (`E8EA9823`). Live `candidates=[]` | Six leftover drafts still present. No named confirm | `owner_proved_pending_fastmcp` |
